...
async function run () {
  ...
  console.log('  kid is an attest kid:        ', ['insumer-attest-v1', 'insumer-attest-v2'].includes(attestResult.kid), attestResult.kid)
  console.log('  pqKid === insumer-attest-pq1:', attestResult.pqKid === 'insumer-attest-pq1')
  ...
  console.log('  kid is a trust kid:          ', ['insumer-attest-v1', 'insumer-trust-v2'].includes(trustResult.kid), trustResult.kid)
  console.log('  pqKid === insumer-trust-pq1: ', trustResult.pqKid === 'insumer-trust-pq1')
